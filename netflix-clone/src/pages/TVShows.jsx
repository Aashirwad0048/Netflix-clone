...
import ThursdayLogo from "../assets/Thursday.png.png";
...
function TVShows() {
  ...
  // Use Thursday Murder Club video and image
  const videoSrc = '/The Thursday Murder Club.mp4';
  const backgroundImage = '/Thursday.jpg';
  const audioSrc = '/The Thursday Murder Club _ Official Trailer _ Netflix.mp3'; // Audio file from public folder
    ...
    <Container>
      ...
      <div className="hero">
        ...
        <div className="container">
          <div className="logo">
            <img src={ThursdayLogo} alt="The Thursday Murder Club" />
          </div>
          <div className="show-info">
            <p>A gripping mystery series following four unlikely friends who meet weekly to investigate cold cases.</p>
          </div>
      ...
      <div className="data">
        {movies.length ? (
          <>
            <Slider movies={movies} contentType="tv" />
          </>
        ) : (
